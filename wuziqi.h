...
void fg4_refresh_value(int x0,int y0,int par_k);
...
int par_board_expanded[MAX_WIDTH][23][23];
int (*par_board[MAX_WIDTH])[23];
int par_lianzhu[MAX_WIDTH][16][16][5];
int par_fg6_value[MAX_WIDTH][16][16][11];
